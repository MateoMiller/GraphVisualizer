...
public class NodeRemovingWindow extends JDialog {
    StateMachine machine;
    JTextField nameTextField;

    public NodeRemovingWindow(StateMachine machine, JFrame parent){
        super(parent);
    ...
    public static void main(String[] args){
        ...
        var window = new NodeRemovingWindow(machine, null);
